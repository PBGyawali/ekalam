<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <img src="<?= asset('favicon.ico') ?>" width="50" height="60" class="img-fluid img-responsive">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('advertisement') }}" :active="request()->routeIs('advertisement')">
                        {{ __('Advertisement') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('video') }}" :active="request()->routeIs('video')">
                        {{ __('Video') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('allnews') }}" >
                        {{ __('Homepage') }}
                    </x-jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('advertisement') }}" :active="request()->routeIs('advertisement')">
                {{ __('Advertisement') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('video') }}" :active="request()->routeIs('video')">
                {{ __('Video') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('allnews') }}" >
                {{ __('Homepage') }}
            </x-jet-responsive-nav-link>
        </div>
