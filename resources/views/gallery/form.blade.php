                        ...
                        <div class="row">
                            ...
                            <div class="control-group col-12 mt-2">
                                ...
                                <div class="col-12 col-sm-6">
                                    @if (isset($gallery) && $gallery->image != null && file_exists(storage_path('/app/public/').'gallery/'.$gallery->image))
                                        <img src="{{config('constants.storage_url').'/gallery/'.$gallery->image }}" title="{{$gallery->image}}" class="img img-fluid img-thumbnail">
                                      @endif
                            ...
                            <div class="control-group row mt-2">
                                 @if (isset($galleryImages) && !empty($galleryImages))
                                    @foreach ($galleryImages as $gallery_image)
                                        @if ($gallery_image->image!= null && file_exists(storage_path('/app/public').'/gallery/'.$gallery_image->image))
                                            <div class="col-12 col-sm-6 col-md-4">
                                                <div class="col-12"> <img src="{{ config('constants.storage_url').'/gallery/'. $gallery_image->image }}" title="{{$gallery_image->image }}"class="img img-fluid img-thumbnail"></div>
