                ...
                <div class="border rounded  mt-5 pl-4 pr-4 pt-4 pb-4">
                    ...
                    <div class="control-group col-12">
                                ...
                                <input type="text" id="title" class="form-control" name="title"
                                       placeholder="Enter Post Title" value="{{ old('title')?old('title'):(isset($post)?$post->title: '' )  }}" required>
                                    @error('title')
                            ...
                            <div class="control-group col-12 mt-2">
                                ...
                                <textarea id="description" class="form-control" name="description" placeholder="Enter Post description"
                                          rows="5" required>{!! old('description')?old('description'):(isset($post)?$post->description: '' ) !!}</textarea>
                                    @error('description')
                                          <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            </div>
                            ...
                            <div class="control-group col-12 col-sm-6 mt-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" name="news_date" class="form-control form-control-sm" value="{{old('news_date')?old('news_date'):(isset($post)?$post->news_date->format('Y-m-d'): '' ) }}" id="news_date"  placeholder="Enter News date..." >
                                </div>
                                @error('news_date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="control-group col-12 mt-2">
                                ...
                                @enderror
                                <div class="col-sm-12">
                                        <img src="{{config('constants.storage_url').'/news/'. (isset($post) ?$post->image: '') }}" alt="" class="img img-fluid img-thumbnail">
                                </div>
                            </div>
                            <div class="control-group col-12 col-sm-6  mt-2">
